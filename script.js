...
function openProfile(nick) {
    ...
    if (skinImg) skinImg.src = 'https://minotar.net' + player.nick + '/100';
...
function renderTable() {
    ...
    if (currentMode === 'overall') { displayPlayers.sort((a, b) => calculatePlayerPoints(b) - calculatePlayerPoints(a)); } 
    else { displayPlayers = displayPlayers.filter(p => p.tiers[currentMode] !== 'NONE'); displayPlayers.sort((a, b) => tierOrder[a.tiers[currentMode]] - tierOrder[b.tiers[currentMode]]); }
